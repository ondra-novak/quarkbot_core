...
class OrderBook
    : public refcnt_ptr<const OrderBookSnapshot, OrderBookSnapshotDeleter>,
      public MarketStreamTypeItem {
public:
    using refcnt_ptr<const OrderBookSnapshot,
                    OrderBookSnapshotDeleter>::refcnt_ptr;
