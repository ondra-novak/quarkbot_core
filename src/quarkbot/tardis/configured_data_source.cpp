...
#include "../backtest/simexchange.hpp"
#include <zlib.h>
#include <fstream>
#include <stdexcept>
#include <string>
...
IMarketInstrument::Info InstrumentSpec::resolve(IExchange &iexchange) const {
    SimExchange &exchange = dynamic_cast<SimExchange &>(iexchange);
