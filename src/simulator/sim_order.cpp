...
using BinOrder = TupleBin<Order::Setup, Decimal, Decimal, Order::State, Order::Reason, std::string>;

SerializedOrder SimOrder::to_binary() const {

    BinOrder::compose(this->_setup, this->_status.filled, this->_status.last_price,
