...
public:
    ...
    virtual awaitable<void> sleep_until(std::chrono::system_clock::time_point time_point, cancel_signal *cancel_signal_ptr = nullptr) override;
    virtual awaitable<void> sleep_for(std::chrono::system_clock::duration duration, cancel_signal *cancel_signal_ptr = nullptr) override;
...
protected:
    ...
    ScheduledQueue<proxy_result<void>, std::chrono::system_clock::time_point, cancel_signal *> _sch_queue;
